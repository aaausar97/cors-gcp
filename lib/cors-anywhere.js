...
function parseURL(req_url) {
  //console.log("Original URL:", req_url); // Debugging: show original URL

  // Decode the URL to handle any encoded characters properly
  req_url = decodeURIComponent(req_url);
  //console.log("After decodeURIComponent:", req_url); // Debugging: show after decoding

  // Replace double %2F with slashes
  req_url = req_url.replace(/%2F/g, '/');
  //console.log("After replacing %2F:", req_url); // Debugging: show after replacing
